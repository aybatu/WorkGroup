...
class EmployeeListDropDownMenu {
    ...
    private var userAccounts: [Employee?] = []
    
    func showDropdownMenu(from button: UIButton, with userAccounts: [Employee?], tableView: UITableView, completion: @escaping (Employee) -> Void) {
